...
const APP_SECRET = "f32d7a3f9e81dad4a6698b771d36af09"; //
...
app.post("/flow", async (req, res) => {
  try {
    ...
    const screenData = {
      version: "3.0",
      screen: "SUCCESS", // ખાતરી કરો કે તમારા Flow JSON માં આ નામની સ્ક્રીન છે
      data: {
    ...
    const encryptedBody = encryptResponse(screenData, aesKeyBuffer, initialVectorBuffer);
...
app.listen(PORT, () => console.log(`🚀 App listening on port ${PORT}!`));import express from "express";
import crypto from "crypto";
import axios from "axios";
